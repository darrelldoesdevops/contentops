...
expected: Release has separate jobs for ARM64 (`macos-latest`, `aarch64-apple-darwin`) and Intel (`macos-latest` cross-compile, `x86_64-apple-darwin`).
result: pass
