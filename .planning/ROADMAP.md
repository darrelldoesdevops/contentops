...
- [ ] **Phase 10: Homebrew Tap + Formula** - Create `darrelldoesdevops/homebrew-tap` repo with architecture-conditional formula; verify `brew install` works on ARM and Intel
